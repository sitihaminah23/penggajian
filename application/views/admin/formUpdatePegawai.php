         ...
         <form method="POST" action="<?php echo base_url('admin/dataPegawai/updateDataAksi') ?>">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
               ...
               <input type="password" name="password" class="form-control" value="<?php echo $p->username ?>">
            ...
            <div class="form-group">
               ...
               <div class="card">
                  <div class="card-body">
                     <?php $s = "Laki-Laki"; ?>
                     <td><input type="radio" name="jenis_kelamin" value="Laki-Laki" <?php if($s == "Laki-Laki")echo 'checked="checked"' ?>> Laki-Laki</td>
                     <br>
                     <td><input type="radio" name="jenis_kelamin" value="Perempuan" <?php if($s == "Perempuan") echo 'checked="checked"' ?>> Perempuan</td>
               </div>
            ...
            <div class="form-group">
               ...
               <select name="hak_akses" class="form-control"><option value="<?php  echo $p->hak_akses?>">
